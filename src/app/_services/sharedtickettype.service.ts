...
import {WorkFlowType} from '../_models/mode_status';
...
export class SharedTicketTypeService {
  ...
  createTicketTypes(ticketType:TicketType) {
    ...
    return this.http.post("http://localhost:8031/tickettype",ticketType)
  }
  ...
  updateTicketType(ticketType:TicketType) {
    ...
    return this.http.put("http://localhost:8031/tickettype",this.ticketType)
    
  }

  getWorkFlow()
  {
    return this.http.get<WorkFlowType[]>("http://172.16.18.180:7090/workflows")
  }
